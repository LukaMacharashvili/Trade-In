...
export class addTradeInImagesData extends BaseActions{
    constructor(payload:any) {
        super();
        super.type = TradeInDataActionTypes.addTradeInImagesData;
        super.payload = payload;
    }
}
...
export class deleteTradeInImagesData extends BaseActions{
    constructor(payload:any) {
        super();
        super.type = TradeInDataActionTypes.deleteTradeInImagesData;
        super.payload = payload;   
    }
}